    ...
    <section id="hero" class="w-full">
      <div class="grid grid-cols-7 items-center">
        ...
        >
          ...
          :class="{ 'text-left': direction === 'ltr', 'text-right': direction === 'rtl' }"
          >
            {{ $t(" This application provides a design matrix to measure the resilience of schools and their different educational spaces during crises. methodology of this application is based on analyzing the resilient design criteria, which include: ") }}<br />       
