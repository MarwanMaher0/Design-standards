<template class="overflow-x-auto">
  ...
  <footer class="fixed bottom-0 left-0 w-full p-2 shadow bg-gray-800">
    <div
      class="w-full flex justify-center mx-auto text-center max-w-screen-xl p-4 md:flex md:items-center md:justify-between"
    >
      <p class="hover:underline me-4 md:me-6 text-gray-400">
        Provided by: O.M.A.
      </p>
    </div>
  </footer>
