<template>
  <div class="tOth-red-300 font-extrabold">
...
const chartData = ref({
  ...
  datasets: [
    {
      data: [
        localStorage.getItem("Oth-columnSum-0"),
        localStorage.getItem("Oth-columnSum-1"),
        localStorage.getItem("Oth-columnSum-2"),
        localStorage.getItem("Oth-columnSum-3"),
      ],
      label: "Other Education Spaces	",
    ...
    datasets: [
      {
        ...
        data: [
          parseFloat(localStorage.getItem("Oth-columnSum-percentage-0") || "0"),
          parseFloat(localStorage.getItem("Oth-columnSum-percentage-1") || "0"),
          parseFloat(localStorage.getItem("Oth-columnSum-percentage-2") || "0"),
          parseFloat(localStorage.getItem("Oth-columnSum-percentage-3") || "0"),
        ],
      },
    ],
  };
