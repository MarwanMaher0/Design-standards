...
const chartData = ref({
  ...
  datasets: [
    {
      data: [localStorage.getItem('Oth-columnSum-0'), localStorage.getItem('Oth-columnSum-1'), localStorage.getItem('Oth-columnSum-2'), localStorage.getItem('Oth-columnSum-3')],
...
const updateChartDataFromLocalStorage = () => {
  chartData.value = {
    ...
    datasets: [{
      ...
      data: [
        parseFloat(localStorage.getItem('Oth-columnSum-0') || '0'),
        parseFloat(localStorage.getItem('Oth-columnSum-1') || '0'),
        parseFloat(localStorage.getItem('Oth-columnSum-2') || '0'),
        parseFloat(localStorage.getItem('Oth-columnSum-3') || '0')
      ]
    }]
  };
};
