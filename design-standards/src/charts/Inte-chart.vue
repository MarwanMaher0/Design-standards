...
const chartData = ref({
  ...
  datasets: [
    {
      data: [localStorage.getItem('Inte-columnSum-0'), localStorage.getItem('Inte-columnSum-1'), localStorage.getItem('Inte-columnSum-2'), localStorage.getItem('Inte-columnSum-3')],
...
const updateChartDataFromLocalStorage = () => {
  chartData.value = {
    ...
    datasets: [{
      ...
      data: [
        parseFloat(localStorage.getItem('Inte-columnSum-0') || '0'),
        parseFloat(localStorage.getItem('Inte-columnSum-1') || '0'),
        parseFloat(localStorage.getItem('Inte-columnSum-2') || '0'),
        parseFloat(localStorage.getItem('Inte-columnSum-3') || '0')
      ]
    }]
  };
};
