    ...
    datasets: [
      {
        ...
        data: [
          parseFloat(localStorage.getItem("Ext-columnSum-percentage-0") || "0"),
          parseFloat(localStorage.getItem("Ext-columnSum-percentage-1") || "0"),
          parseFloat(localStorage.getItem("Ext-columnSum-percentage-2") || "0"),
          parseFloat(localStorage.getItem("Ext-columnSum-percentage-3") || "0"),
        ],
      },
    ],
  };
