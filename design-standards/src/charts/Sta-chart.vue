...
const chartData = ref({
  ...
  datasets: [
    {
      data: [
        localStorage.getItem("sta-columnSum-0"),
        localStorage.getItem("sta-columnSum-1"),
        localStorage.getItem("sta-columnSum-2"),
        localStorage.getItem("sta-columnSum-3"),
      ],
    ...
    datasets: [
      {
        ...
        data: [
          parseFloat(localStorage.getItem("sta-columnSum-percentage-0") || "0"),
          parseFloat(localStorage.getItem("sta-columnSum-percentage-1") || "0"),
          parseFloat(localStorage.getItem("sta-columnSum-percentage-2") || "0"),
          parseFloat(localStorage.getItem("sta-columnSum-percentage-3") || "0"),
        ],
      },
    ],
  };
