<template>
  <div class="">
    <table class="max-lg:min-w-[900px] overflow-x-auto">
      <tr id="Inte-row-1">
        <td
          class="bg-[#2f5496] pt-[65rem] text-gray-100"
          rowspan="115"
          colspan="1"
        >
      ...
      <tr id="Inte-row-7">
        ...
        <td class="bg-white">
          <img
            src="../assets/d96c4f8d-6ac9-4c2f-b177-e875764d5f54.jpeg"
            class="mx-auto w-14 h-10"
            alt=""
          />
        </td>
        <td class="bg-white">
      ...
      <tr id="Inte-row-17" class="bg-[#c8c8c8]">
        ...
        <td rowspan="7" colspan="1">
          {{
            $t(
              " Precautionary measures for direct contact in the classroom (social distancing between students) "
            )
          }}
        </td>
        <div class="hidden">/</div>
      ...
      <tr id="Inte-row-26">
        ...
        <td>{{ $t(" smart board for hybrid and online learning ") }}</td>
        <div class="hidden">/</div>
      ...
      <tr id="Inte-row-52">
        ...
        <td rowspan="1" colspan="3">
          {{
            $t(" Opening Area (not less than 18-20% of the classroom area) ")
          }}
        </td>
        <td class="bg-white">
      ...
      <tr id="Inte-row-56" class="bg-[#c8c8c8]">
        ...
        <td class="bg-white">
          <img
            src="../assets/2cea0785-dd50-4639-be9f-8e0944cf97fd.jpeg"
            class="mx-auto w-10"
            alt=""
          />
        </td>
      ...
      <tr id="Inte-row-88" class="bg-[#c8c8c8]">
        ...
        <td rowspan="11" colspan="1">
          {{
            $t(
              " Various surfaces (floors - furniture - other surfaces) and Survival period (hours-day) "
            )
          }}
        </td>
        <div class="hidden">/</div>
