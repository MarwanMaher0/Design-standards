<template>
  <div class="">
    <table class="min-x-[1000px] max-lg:w-[900px] overflow-x-auto">
      ...
      <tr id="sta-row-2">
        <td rowspan="1" colspan="3">
          {{ $t("Windows Sill (1.20 - 1.50m) ") }}
        </td>

        <td class="bg-white">
          <center>
            <img src="../assets/Picture115.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-3">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture116.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-4">
        <td rowspan="1" colspan="3">
          {{ $t("Floor materials resistant to friction (use marble) ") }}
        </td>
      ...
      <tr id="sta-row-5">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture153.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-6">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture151.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-7">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture122.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-9">
        ...
        <td class="bg-white">
          <center>
            <img class="h-4" src="../assets/Picture124.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-12">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture126.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-13">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture127.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-14">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture128.jpg   " alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-15">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture129.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-16">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture130.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-18">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture132.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-20" class="bg-[#c8c8c8]">
        <td rowspan="8" colspan="1">
          {{ $t("Precautionary Measures for Stairs and Corridors ") }}
        </td>
        <td rowspan="3" colspan="1">
          {{ $t("Finishes ") }}
        </td>
      ...
      <tr id="sta-row-21" class="bg-[#c8c8c8]">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture134.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-22" class="bg-[#c8c8c8]">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture135.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-23" class="bg-[#c8c8c8]">
        <td rowspan="2" colspan="1">
          {{ $t("Environmental criteria ") }}
        </td>
        <td>{{ $t("Ventilation ") }}</td>
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture136.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-24" class="bg-[#c8c8c8]">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture137.jpg" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-25" class="bg-[#c8c8c8]">
        ...
        <td class="bg-white">
          <center>
            <img src="../assets/Picture138.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-26" class="bg-[#c8c8c8]">
        <td rowspan="1" colspan="3">
          {{ $t("smart doors and windows without touching ") }}
        </td>

        <td class="bg-white">
          <center>
            <img src="../assets/Picture139.png" alt="" />
          </center>
        </td>
        <td class="bg-white">
          <input
      ...
      <tr id="sta-row-27" class="bg-[#c8c8c8]">
        <td rowspan="1" colspan="3">
          {{ $t("Touchless devices ") }}
        </td>
      ...
      <tr class="bg-[#8eaadb]" id="sta-row-28">
        <td rowspan="1" colspan="7">
          {{
            $t(
              "No. of Realized Points for Resilient Design Criteria in Stairs and Corridors "
            )
          }}
        </td>
        ...
        <td rowspan="6">
          <button v-if="showEnhancestaOpen" @click="openEnhancestaForm()">
            Start Enhance
          </button>
          <button v-if="showEnhancestaBTN" @click="close()">
            End Enhance
          </button>
        </td>
      </tr>
      <tr id="sta-row-29" class="bg-[#8eaadb]">
        <td rowspan="1" colspan="7">
          {{
            $t(
              "Total No. of Realized Points for Resilient Design Criteria in Stairs and Corridors "
            )
          }}
        </td>
      ...
      <tr class="bg-[#8eaadb]" id="sta-row-30">
        <td rowspan="1" colspan="7">
          {{
            $t(
              "Percentages of realized Points for Resilient Design Criteria in Stairs and Corridors "
            )
          }}
        </td>
      ...
      <tr class="bg-[#8eaadb]" id="sta-row-31">
        <td rowspan="1" colspan="7">
          {{
            $t(
              "Total Percentages of Realized Points for Resilient Design Criteria in Stairs and Corridors "
            )
          }}
        </td>
      ...
      <tr id="sta-row-32 " class="bg-[#b4c6e7]">
        <td rowspan="1" colspan="7">
          {{
            $t(
              "Required Points for Resilient Design Criteria in Stairs and Corridors "
            )
          }}
        </td>
      ...
      <tr id="sta-row-33" class="bg-[#b4c6e7]">
        <td rowspan="1" colspan="7">
          {{
            $t(
              "Total Required Points for Resilient Design Criteria in Stairs and Corridors "
            )
          }}
        </td>

        <td></td>
        <td rowspan="1" colspan="4">51</td>
      </tr>
    </table>
  </div>
  <div class="block">
          ...
          >
            ...
            <div class="max-h-96 overflow-x-auto">
              ...
              >
                ...
                <tbody>
                  <tr
                    v-for="(row, index) in parsedTextArraysta"
                    :key="index"
...
onMounted(() => {
  ...
  parsedTextArraysta.value = getParsedDataFromLocalStoragesta();
...
const initializeCheckboxes = () => {
  rows.value.forEach((row, rowIndex) => {
    ...
    checkboxesInRow.forEach((checkbox, checkboxIndex) => {
      checkbox.checked =
        localStorage.getItem(`sta-row-${row.id}-checkbox-${checkboxIndex}`) ===
        "true";
...
const handleCheckboxChange = (event, rowIndex) => {
  ...
  groupsta.forEach((groupId) => {
    if (groupId !== row.id) {
      const otherRow = document.getElementById(groupId);
      if (otherRow && groupsta.includes(row.id)) {
        ...
        checkboxesInOtherRow.forEach((otherCheckbox, checkboxIndex) => {
          ...
          const localStorageKey = `sta-row-${groupId}-checkbox-value-${checkboxIndex}`;
          const localStorageKey2 = `sta-row-${groupId}-checkbox-${checkboxIndex}`;
...
const percentageFrom80 = computed(() => {
  return (totalSum.value / 51) * 100;
});
const percentageFrom24 = computed(() => {
  return (columnSums.value[0] / 18) * 100;
});
const percentageFrom19 = computed(() => {
  return (columnSums.value[1] / 10) * 100;
});
...
const checkboxes = document.querySelectorAll(
  'tr[id^="sta-"] input[type="checkbox"][name="ahosting"]'
);
...
watch(
  ...
  (newColumnSums) => {
    localStorage.setItem(
      "sta-columnSum-percentage-0",
      percentageFrom24.value.toFixed(2)
    );
    localStorage.setItem(
      "sta-columnSum-percentage-1",
      percentageFrom19.value.toFixed(2)
    );
    localStorage.setItem(
      "sta-columnSum-percentage-2",
      percentageFrom10.value.toFixed(2)
    );
    localStorage.setItem(
      "sta-columnSum-percentage-3",
...
let parsedTextArraysta = ref([]);

let showEnhancestaForm = ref(false);
const close = () => {
  showEnhancestaForm.value = false;
};
const openEnhancestaForm = () => {
  parsedTextArraysta.value = getParsedDataFromLocalStoragesta();

  showEnhancestaForm.value = true;
};
const getParsedDataFromLocalStoragesta = () => {
  const AllRowsArray = [];
  ...
  const parsedTextArraysta = AllRowsArray.map((item) => {
  ...
  const jsonData = JSON.stringify(parsedTextArraysta);

  return parsedTextArraysta;
};
</script>
